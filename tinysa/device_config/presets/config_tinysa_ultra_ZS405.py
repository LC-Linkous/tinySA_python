...
##--------------------------------------------------------------------\
#   tinySA_python  config_tinysa_ultra_ZS405.py
#   
...
## INPUT 
# spectrum analyzer
SA_INPUT_FREQS = {"low":[100e3, 800e6], "high":[100e3, 5.3e9], "all":[100e3, 10e9]}
SA_INPUT_FREQS_ULTRA = {"all":[100e3,  5.3e9]}
...
MAX_LOW_OUTPUT_FREQ = {"sine": 800e6, "square": 4.4e9} # Sine wave up to 800MHz, Square wave up to 4.4GHz 
MAX_HIGH_OUTPUT_FREQ = {"sine": 800e6, "square": 4.4e9} #none specified, but high and low share range for Ultra/+
OUTPUT_LEVEL = {"low":[-115, -19], "high":[-115, -19]} #dBm


SG_DEVICE_FREQS_SINE = {"low":[100e3, 800e6], "high":[100e3, 800e6], "all":[100e3, 800e6]}
